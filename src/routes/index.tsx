        ...
        <div className="container-x">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <h2 className="mt-3 text-3xl md:text-5xl font-bold text-balance">
                Full-spectrum construction <br className="hidden md:block" />chemical solutions.
              </h2>
            </div>
            <Link to="/services" className="text-sm font-semibold text-brand inline-flex items-center gap-2 hover:gap-3 transition-all">
            ...
            {CATEGORIES.map((c) => {
              ...
              return (
                <Link
                  to="/services"
                  key={c}
                  className="group relative bg-card border rounded-2xl p-6 hover:shadow-elegant hover:-translate-y-1 transition-all duration-300"
                >
                  <div className="w-12 h-12 rounded-xl bg-gradient-brand flex items-center justify-center text-brand-foreground shadow-brand">
                    <Icon className="h-6 w-6" />
                  </div>
                  <h3 className="mt-5 font-semibold text-lg leading-tight">{c}</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Specialist crews · turnkey delivery · warrantied systems.
                  </p>
                  <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-brand opacity-0 group-hover:opacity-100 transition">
